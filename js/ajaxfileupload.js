    ...
    $.fn.imgPreview = function(options) {
        ...
        $(this).each(function() {
           // if(typeof FileReader == 'undefined') return true;
            ...
            var fileInput = elem.bind('change', function(e) {
                doImgPreview(e);
            });
            ...
            var newDiv = $('<div>').addClass('image-preview').css({
                width :settings.thumbnail_size + 'px'
            });
            if ( settings.current ) {
                $(newDiv).css({backgroundImage: 'url('+settings.current+')'});
            }
            ...
            elem.after(newFileInput);
            newFileInput.append(fileInput);
            ...
            var doImgPreview = function(e) {
                ...
                for (var i=0, file; file=files[i]; i++) {
                    if (file.type.match('image.*')) {
                        ...
                        printMessage('error', lang['not_image_file']);
                    }
                }
            }
...
jQuery.extend({
    ...
    createUploadForm: function(id, fileElementId, data)
	{
        ...
        var events = jQuery._data(oldElement.get(0), 'events');
        newElement.bind('change', events.change[0]);
